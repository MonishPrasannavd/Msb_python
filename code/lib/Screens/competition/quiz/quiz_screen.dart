                        ...
                        itemCount: categoryList.length,
                          ...
                          final item = categoryList[index];
                            return CategoryTile(
                              ...
                              subcategories: item.types.map((e) => e).toList(),
                              title: item.name
                            );
                        })
                    ],
...
class CategoryTile extends StatefulWidget {
  ...
  const CategoryTile({super.key, 
    ...
    required this.subcategories, required this.title,
  });
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 4.0),
        child: Container(
          padding: EdgeInsets.only(bottom: _isExpanded? 10 : 0, left: 0, right: 0),
          ...
          child: ExpansionTile(
            ...
            shape: const RoundedRectangleBorder(
              side: BorderSide(color: Colors.transparent), // Remove top and bottom lines when expanded
            ),
            ...
            children: widget.subcategories.map((subcategory) => Padding(
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    PrefsService.setString('selectedQuizGrade', subcategory.name);
                    callNextScreen(context, QuizDetailScreen(subcategory.quizIds, widget.title));
                  },
                ),
              ),
            ))
